...
1. Generate a series of actionable tasks that the submitter must complete. These task are supposed to be minor updates on existing figma file that tests the targeted skillset. Each task should be directly related to the submission and designed to thoroughly evaluate the corresponding claimed skillsets.
